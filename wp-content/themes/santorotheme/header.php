...
<head>
    ...
    <link rel="apple-touch-icon" sizes="57x57"
        href="<?php bloginfo('template_url'); ?>/img/favicon/apple-icon-57x57.png">
    <link rel="apple-touch-icon" sizes="60x60"
        href="<?php bloginfo('template_url'); ?>/img/favicon/apple-icon-60x60.png">
    <link rel="apple-touch-icon" sizes="72x72"
        href="<?php bloginfo('template_url'); ?>/img/favicon//apple-icon-72x72.png">
    <link rel="apple-touch-icon" sizes="76x76"
        href="<?php bloginfo('template_url'); ?>/img/favicon//apple-icon-76x76.png">
    <link rel="apple-touch-icon" sizes="114x114"
        href="<?php bloginfo('template_url'); ?>/img/favicon/apple-icon-114x114.png">
    <link rel="apple-touch-icon" sizes="120x120"
        href="<?php bloginfo('template_url'); ?>/img/favicon/apple-icon-120x120.png">
    <link rel="apple-touch-icon" sizes="144x144"
        href="<?php bloginfo('template_url'); ?>/img/favicon/apple-icon-144x144.png">
    <link rel="apple-touch-icon" sizes="152x152"
        href="<?php bloginfo('template_url'); ?>/img/favicon/apple-icon-152x152.png">
    <link rel="apple-touch-icon" sizes="180x180"
        href="<?php bloginfo('template_url'); ?>/img/favicon/apple-icon-180x180.png">
    <link rel="icon" type="image/png" sizes="192x192"
        href="<?php bloginfo('template_url'); ?>/img/favicon/android-icon-192x192.png">
    <link rel="icon" type="image/png" sizes="32x32"
        href="<?php bloginfo('template_url'); ?>/img/favicon/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="96x96"
        href="<?php bloginfo('template_url'); ?>/img/favicon/favicon-96x96.png">
    <link rel="icon" type="image/png" sizes="16x16"
        href="<?php bloginfo('template_url'); ?>/img/favicon/favicon-16x16.png">
...
<body>
    ...
    <script>
    var identify = new amplitude.Identify().set('plan', '<?php echo $user_plan; ?>').set('email',
        '<?php echo $current_user_email; ?>').set('es_regalo', '<?php echo $current_user_es_regalo; ?>');
    amplitude.getInstance().identify(identify);
        ...
        <a class="navbar-brand text-white">
            <a id="js-logo-link" href="<?php echo home_url('/'); ?>">
                <div class="logo-wrapper">
                    <img class="logo-img" id="js-logo-img"
                        src="<?php bloginfo('template_url'); ?>/img/logo-theclassyoga-black.png" alt="Logo" />
                    <div class="logo-text">
...
?>
        ...
        <div class="collapse navbar-collapse" id="opciones">
            ...
            <ul class="navbar-nav navbar-right">
                <li class="nav-item">
                    <a class="nav-link <?php echo $programas_active?>"
                        href="<?php echo home_url()?>/programas-yoga">PROGRAMAS DE YOGA</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo $clases_active?>"
                        href="<?php echo home_url()?>/clases-grabadas">CLASES GRABADAS</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo $directo_active?>"
                        href="<?php echo home_url()?>/clases-directo">CLASES DIRECTO</a>
                </li>


                <li class="nav-item">
                    <a class="nav-link <?php echo $lee_active?>" href="<?php echo home_url()?>/blog">BLOG</a>
                </li>
          ...
          ?>
                    ...
                    <button class="btn btn-secondary btn-sign-in"
